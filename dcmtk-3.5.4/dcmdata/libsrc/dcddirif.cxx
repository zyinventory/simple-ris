                                                          ...
                                                          const OFString &sourceFilename)
{
    ...
    if (record != NULL)
    {
        ...
        if (record->error().good())
        {
            ...
            copyElement(dataset, DCM_SpecificCharacterSet, record, OFTrue /*optional*/);
            copyElement(dataset, DCM_RETIRED_OverlayNumber, record);
        } else {
                                                              ...
                                                              const OFString &sourceFilename)
{
    ...
    if (record != NULL)
    {
        ...
        if (record->error().good())
        {
            ...
            copyElement(dataset, DCM_SpecificCharacterSet, record, OFTrue /*optional*/);
            copyElement(dataset, DCM_RETIRED_LookupTableNumber, record);
        } else {
                                                        ...
                                                        const OFString &sourceFilename)
{
    ...
    if (record != NULL)
    {
        ...
        if (record->error().good())
        {
            ...
            copyElement(dataset, DCM_SpecificCharacterSet, record, OFTrue /*optional*/);
            copyElement(dataset, DCM_RETIRED_CurveNumber, record);
        } else {
